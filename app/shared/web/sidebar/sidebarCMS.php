        ...
        echo '<div class="span3">
                    <div class="sidebar-nav">
                        ...
                        <ul id="galeria-menu" class="nav nav-list collapse in">
                            <li ><a href="../../cms/galeria/listaGaleria.php">Lista Fotografías</a></li>
                        </ul>
                        
                        <div class="nav-header" data-toggle="collapse" data-target="#tablero-menu"><i class="icon-briefcase"></i>Tablero Adopciones</div>
